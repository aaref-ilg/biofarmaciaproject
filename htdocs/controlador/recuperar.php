...
try {
    ...
    $mail->Username   = 'info.biofarmacia@gmail.com';                     // SMTP username
    $mail->Password   = 'biofarmacia2022';                               // SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;         // Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
    $mail->Port       = 587;                                    // TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above

    //Recipients
    $mail->setFrom('info.biofarmacia@gmail.com', 'Sistema administrativo');
              ...
              <tr>
                <td valign="top" width="270" style="background:#1f1f1f; text-align:left;">
                  <a href="#" style="text-decoration:none;">
                    <img src="https://i.postimg.cc/jSMnQ8Gd/logo.png"  width="50" height="50" alt="Your Logo"/>
                  </a>
            ...
            <table cellpadding="0" cellspacing="0" width="600" class="w320">
              <tr>
                <td align="left" class="mobile-padding" style="padding:20px 20px 30px">
                  ...
                  <h1><span style="color:#D41C23;">BIO</span>Farmacia</h1>
                        ...
                        <table width="94" align="right" cellpadding="0" cellspacing="0">
                          <tr>
                            <td style="border:2px solid #000000">
                              <img src="https://i.postimg.cc/BnbnsJV4/627aa84aea89a-default.png" style="display:block" width="120" height="90" alt="profile"/>
                            </td>
                          </tr>
                        </table>
                      </td>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="600" class="w320" style="height:100%;">
              <tr>
                <td valign="top" class="mobile-padding" style="padding:20px;">
                  ...
                  <br>
                  * Si usted tiene problemas para recuperar su contraseña puede volver a generar la solicitud de cambio de contraseña.
                  <br>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="600" class="w320" style="height:100%;color:#ffffff" bgcolor="#1f1f1f" >
              <tr>
                <td align="right" valign="middle" class="mobile-padding" style="font-size:12px;padding:20px; background-color:#1f1f1f; color:#ffffff; text-align:left; ">
                  <h4 style="color:#ffffff;"  href="#">Creado por BioFarmacia | 2022</h4>
